...
struct FrameState {
	...
	BYTE oam[0x220] = {};
	WORD simonAnimationCounter = 0xFFFF;
	WORD simonSubAnimationCounter = 0xFFFF;
	WORD simonSpriteAttribute = 0xFFFF;
...
public:
	...
	bool ReadWram(unsigned snesAddress, unsigned byteCount, unsigned &value);
...
private:
	...
	bool WaitForSnesStateMessage(MSG &msg, DWORD timeoutMs, const char *timeoutText);
